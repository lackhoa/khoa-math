...
# They cause AssertionError if used incorrectly
...
def thm_intro(thm_, args: List, id_: int):
    '''
    Theorem introduction
    :param args: the list of arguments to be passed to the theorem
    '''
    assert(thm_.type == MathType.PL_THEOREM)

    return line(id_, thm_.func(*args), rule_anno('TI', [str(thm_), *args]), set())
